...
const APP_CHANGELOG = [
    ...
    },
    {
        ...
        changes: [
            ...
            '[优化] 文案一致性修复：帮助文档同步更新为“云端同步 + 本地缓存 + 导出备份”三层说明。'
        ]
    },
    {
        version: '1.3.2',
        date: '2026/3/3',
        changes: [
            '[新特性] 看板核心算法跃升：重构数据统计逻辑，现已支持精确下钻至「子项细分维度」。',
            '[优化] 细分数据深度洞察：看板现可显示「最偏爱的子项分数」及触发次数，并全局统计「累计评定的细分项总数」。',
            '[优化] 项目文档与状态更新：完善 README 与关于页说明，标明项目正处于高速迭代的繁荣期。'
        ]
    },{
        version: '1.3.1',
        date: '2026/3/2',
